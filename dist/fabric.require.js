...
console.log('no image createText');
                    createText(text, options);
                }
            },
...
console.log('render:');
                ...
                if (this.width === 0 || this.height === 0) {
                    console.log('no width or height so no render.')
                    return;
                }
...
console.log('render textObject');
            ...
            _render: function(ctx)
            {
                ...
                if (this.active && !this.boxImage) {
                    console.log('_render active');
                    ctx.save();
            ...
            _moveText: function(ctx) {
                ...
                if (this.textAlign === 'left') {
                    //x = x - ((this.width * scaleX) / 2) + (this.textObject.width / 2) + (this.getTextPadding('x'));
console.log('_moveText textAlign left');
console.log('  this.left=' + this.left);
console.log('  this.textObject.left=' + this.textObject.left);
console.log('  this.width=' + this.width);
console.log('  this.textObject.width=' + this.textObject.width);
                    //x = x - ((this.width * scaleX) / 2) + (this.getTextPadding('x') * scaleX);
//x = this.left - this.textObject.width - (this.getTextPadding('x') * scaleX);
                    //x = x - ((this.width * scaleX) / 2) - (this.textObject.width * scaleX) + (this.getTextPadding('x') * scaleX);
                    x = x - ((this.width * scaleX) / 2) + (this.textObject.width * scaleX / 2) + (this.getTextPadding('x'));
                    this.textObject.set("left", x);
                } else if (this.textAlign === 'right') {
                    //x = x + ((this.get("width") * scaleX) / 2) - (this.textObject.get('width') / 2) - (this.getTextPadding('x'));
                    x = x + ((this.width * scaleX) / 2) - (this.getTextPadding('x'));
                }
            ...
            _wrapText: function (ctx, text) {
                ...
                var maxWidth = (this.width * scaleX),
                    lines = text.split("\n"),
                    wrapped_text = [];
console.log('_wrapText maxWidth=' + maxWidth);
